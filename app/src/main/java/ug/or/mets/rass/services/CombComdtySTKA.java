...
public abstract class CombComdtySTKA extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try
        {
            ...
            String url = Constants.API+"?cmd=AdultsCommodSTKA&uid="+ URLEncoder.encode(mUid, "UTF-8")+"&yr="+URLEncoder.encode(mYear, "UTF-8")+"&wk="+URLEncoder.encode(mWeekNo, "UTF-8");
