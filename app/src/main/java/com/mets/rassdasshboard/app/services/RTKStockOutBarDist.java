...
public abstract class RTKStockOutBarDist extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try
        {
            ...
            String url = Constants.API+"?cmd=RTKDistGraphs&level="+ URLEncoder.encode(mLevel, "UTF-8")+"&week="+URLEncoder.encode(mWeek, "UTF-8")+"&entity="+URLEncoder.encode(mEntity, "UTF-8");
