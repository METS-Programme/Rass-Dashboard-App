...
public abstract class STKCStockOutBarRegional extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try
        {
            ...
            map.put("cmd", "myRegionalDistStuffSTKC");
            map.put("region", mRegion);
            map.put("week", mWeek);

            Log.e("sent d", mRegion);

            String url = Constants.API+"?cmd=myRegionalDistStuffSTKC&region="+ URLEncoder.encode(mRegion, "UTF-8")+"&week="+URLEncoder.encode(mWeek, "UTF-8");
