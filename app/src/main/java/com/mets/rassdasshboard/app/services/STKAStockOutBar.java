...
public abstract class STKAStockOutBar extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try
        {
            ...
            map.put("cmd", "AdultsGraphs");
            map.put("level", mLevel);
            map.put("week", mWeek);

            Log.e("sent d", mLevel);

            String url = Constants.API+"?cmd=AdultsGraphs&level="+ URLEncoder.encode(mLevel, "UTF-8")+"&week="+URLEncoder.encode(mWeek, "UTF-8");
