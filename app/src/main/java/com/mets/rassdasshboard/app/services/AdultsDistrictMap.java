...
public abstract class AdultsDistrictMap extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try
        {
            ...
            map.put("cmd", "myRegionalDistStuffSTKA");
            map.put("region", mRegion);
            map.put("week", mWeek);
            Log.e("sent d", mRegion);

            String url = Constants.API+"?cmd=myRegionalDistStuffSTKA&region="+ URLEncoder.encode(mRegion, "UTF-8")+"&week="+URLEncoder.encode(mWeek, "UTF-8");
